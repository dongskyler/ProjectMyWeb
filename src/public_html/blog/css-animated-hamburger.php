...
<div class="container maincontent">
  ...
  &lt;span&gt;&lt;/span&gt;
&lt;/button&gt;</code></pre>
  <p>The following CSS code is written in SCSS. Read about <a href="https://skylerdong.com/blog/why-i-use-scss.php">why SCSS is my favorite CSS preprocessor</a>. For clarity, I removed vendor prefixes for transforms and transitions. You can generate them using a CSS post-processor such as <a href="https://autoprefixer.github.io" target="_blank">Autoprefixer</a>.</p>
