...
<div class="container maincontent">
    <div>
        <p>
            I'm currently building this website by writing HTML and PHP from scratch and modifying Bootstrap CSS.
        </p>
    </div>
	...
	<ul id="descriptions">
		...
		<p>Nearly 4.5 billion kilometers (2.8 billion miles) from the Sun, Neptune orbits the Sun once every 165 years. It is invisible to the naked eye because of its extreme distance from Earth.</p>
		</li>
	</ul>
