  ...
  <h1>Camera Brand Search Trends of Canon, Nikon and Sony</h1>
    <div class="row">
      <div class="col-12 mb-3 col-md-10">
        <p><a href="https://github.com/tangaw" target="_blank" rel=”noreferrer”>Aaron Tang</a> and I wrote <a href="<?php echo PATH; ?>/coding/scrape-google-trends.php" target="_blank" rel=”noreferrer”>a piece of code in Python to scrape Google trends data</a>. Here we present the data.</p>
