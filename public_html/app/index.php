  ...
  <div class="container maincontent">
    <div class="row">
      <div class="filter-button-bar col-12 mx-auto col-md-10">
        ...
        <button type="button" class="filter-button btn btn-outline-primary" data-class="github-api">GitHub&nbsp;API</button>
      ...
      <div class='col-12 mx-auto col-md-10'>
        ...
        <div class="post-preview filterE" data-class="d3-js javascript python">
          <button type="button" class="filter-button btn btn-outline-primary btn-sm" data-class="github-api">GitHub&nbsp;API</button>
          <button type="button" class="filter-button btn btn-outline-primary btn-sm" data-class="html-css">HTML&nbsp;+&nbsp;CSS</button>
          <button type="button" class="filter-button btn btn-outline-primary btn-sm" data-class="javascript">JavaScript</button>
          <a href="https://badwaterbay.com/app/github-label-manager-plus/" target="_blank" rel="noreferer noopener">
            <h2 class="post-title">GitHub Label Manager Plus</h2>
            <h3 class="post-subtitle">Web app that manages and migrates your GitHub labels and milestones via GitHub API, built with JQuery, Ajax and Bootstrap-Material-Design
            </h3>
          </a>
          <hr />
        </div>
