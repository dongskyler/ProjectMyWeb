  ...
  <div class="row">
    <div class="col-12 mx-auto col-md-10">
      ...
      <div class="mb-5"><h2 id="blog-color-grading-why" class="anchor">Why we do color grading?</h2>
        ...
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_100" target="_blank" rel=”noreferrer”>
        ...
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_83" target="_blank" rel=”noreferrer”>
        ...
        <p>Now let's take the cover photo for an in-depth demonstration, which is also included in <a href="../photography" target="_blank" rel=”noreferrer”>my photo gallery</a>. Take a look at the following 2 photos.</p>
        <p>Which one do you like better?</p>
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_61" target="_blank" rel=”noreferrer”>
          ...
          <div class="col-md-6 mx-auto">
            ...
            <div class="text-center"><p>Photo 2. After: Big Bend National Park, Texas. Although this photo might seem to be a little too much, it is because it's right next to its before photo (Photo 1), which is simply too raw, so our brain started to overcompensate. If you look at this photo in <a href="<?php echo PATH; ?>/photography/?photo=photoid_61" target="_blank" rel=”noreferrer”>my photo gallery</a>, it's quite coherent.</p></div>
          </div>
        </a>
        </div><!--ROW-->
        <p>Well, it is subjective. Personally, I like Photo 2 &mdash; because I was purposely going for that way.</p>
        <blockquote>I wanted to create a slightly surrealistic Wild West feel in Photo 2, like the tone you see in <a href="https://en.wikipedia.org/wiki/Western_(genre)" target="_blank" rel=”noreferrer”>Western films</a>, such as <a href="https://en.wikipedia.org/wiki/The_Good,_the_Bad_and_the_Ugly" target="_blank" rel=”noreferrer”>The Good, the Bad and the Ugly</a> and <a href="https://en.wikipedia.org/wiki/No_Country_for_Old_Men_(film)" target="_blank" rel=”noreferrer”>No Country for Old Men</a>.</blockquote>
        <p>The after photo (Photo 2) might seem to be enhanced too much, but it is because the before photo (Photo 1) &mdash; right next to it &mdash; is too raw and too flat. As a result, our brains kick in and start to overcompensate. If you look at Photo 2 as part of <a href="<?php echo PATH; ?>/photography/?photo=photoid_61" target="_blank" rel=”noreferrer”>my photo gallery</a> or on its own, it is quite coherent.</p>
        <p>On a side note, all color grading settings for all photos in this blog are tailored to small photo previews on screens (maximum 800 pixels on the long edge) for applications like <a href="https://www.instagram.com/skyler.dong.art/" target="_blank" rel=”noreferrer”>Instagram</a> and <a href="../photography" target="_blank" rel=”noreferrer”>my photo gallery</a> on this website. Small photo previews tend to be flat and lackluster, so I add a little more zing to them in post-processing. For larger sizes (such as for computer wallpapers) and prints, I'd tone it down and do a slightly different set of color grading.</p>
      ...
      <div class="mb-5"><h2 id="blog-color-grading-what" class="anchor">What is color grading?</h2>
        <p>Color grading is the process of improving the appearance of an image presentation by adjusting various attributes of an image such as contrast, color, saturation, detail, black level and white point, according to <a href="https://en.wikipedia.org/wiki/Color_grading" target="_blank" rel=”noreferrer”>Wikipedia</a>.</p>
      ...
      <div class="mb-5"><h2 id="blog-color-grading-art" class="anchor">What is art?</h2>
        ...
        <p>One might argue Photo 2 is unrealistic. But what is "reality?" Is what we see "reality?" If I was wearing a pair of brown sunglasses at Big Bend National Park, everything I saw would have a brown tint. Is that reality? What about <a href="https://en.wikipedia.org/wiki/Optical_illusion" target="_blank" rel=”noreferrer”>optical illusions</a>? What about <a href="https://en.wikipedia.org/wiki/Blind_spot_(vision)" target="_blank" rel=”noreferrer”>the blind spot on our retinae</a>? You see, the rabbit hole is quite deep, so I'm going to pause here.</p>
        <p>Although this section seems to be cliches, but this discussion is crucial. I'm trying to free your mind, as an artist, as a photographer, like Morpheus trying to free Neo's mind in the <a href="https://en.wikipedia.org/wiki/The_Matrix" target="_blank" rel=”noreferrer”>Matrix</a> &mdash; which, by the way, has a beautifully unique greenish cinematography by <a href="https://en.wikipedia.org/wiki/Bill_Pope" target="_blank" rel=”noreferrer”>Bill Pope</a> &mdash; and I don't mean I'm nearly as wise as Morpheus.</p>
      ...
      <div class="mb-5"><h2 id="blog-color-grading-how" class="anchor">How to do color grading?</h2>
        ...
        <div class="row photo-block">
          ...
          <div class="col-md-6 mx-auto">
            ...
            <div class="text-center"><p>Photo 2. After post-processing. As I mentioned, although this photo might seem to be a little too much, it is because it's right next to its before photo (Photo 1), which is simply too raw, so our brain started to overcompensate. If you look at this photo as part of <a href="<?php echo PATH; ?>/photography/?photo=photoid_61" target="_blank" rel=”noreferrer”>my photo gallery</a>, it's quite coherent.</p></div>
          </div>
        </a>
        </div><!--ROW-->
        <div class="row photo-block">
      ...
      <div class="mb-5"><h2 id="blog-color-grading-bold" class="anchor">Go bold with color grading</h2>
        ...
        <p>The following photo was taken at <a href="https://en.wikipedia.org/wiki/Prada_Marfa" target="_blank" rel=”noreferrer”>Prada Marfa</a>, which isn't a Prada store, but a sculpture just off highway (U.S. Route 90 in Texas). The closest town is tens of miles away. It's bizarre to have a Prada store in the middle of nowhere.</p>
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_12" target="_blank" rel=”noreferrer”>
            <?php loadImage_blog('SD_IMG_0803_Web_2_raw.jpg');?>
            </a>
            <div class="text-center"><p>Photo 5. <a href="https://en.wikipedia.org/wiki/Prada_Marfa" target="_blank" rel=”noreferrer”>Prada Marfa</a>. Raw photo before post-processing. It's flat and boring and has distorted perspectives that impair the delivery of the photo.</p></div>
          </div>
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_12" target="_blank" rel=”noreferrer”>
            <?php loadImage_photography('SD_IMG_0803_Web.jpg');?>
            </a>
            <div class="text-center"><p>Photo 6. <a href="https://en.wikipedia.org/wiki/Prada_Marfa" target="_blank" rel=”noreferrer”>Prada Marfa</a> after post-processing. I wanted the photo to be as surrealistic — or as realistic — as having a real Prada store in the middle of nowhere.</p></div>
          </div>
        </a>
        </div><!--ROW-->
      ...
      <div class="mb-5"><h2 id="blog-color-grading-technical" class="anchor">Technical considerations</h2>
        <p>There are two technical considerations: <a href="https://en.wikipedia.org/wiki/Raw_image_format" target="_blank" rel=”noreferrer”>shoot RAW</a> and post-processing software.</p>
        <p>It is important to <a href="https://en.wikipedia.org/wiki/Raw_image_format" target="_blank" rel=”noreferrer”>shoot RAW</a>, which means I ask the camera to store all unprocessed data from its sensor in the memory card without any in-camera rendering and compression. Otherwise, the camera might automatically render photos and store them in jpeg format by default, which constitutes data loss, making it harder for post-processing. <a href="https://en.wikipedia.org/wiki/Raw_image_format" target="_blank" rel=”noreferrer”>Shooting RAW</a> gives you the maximum amount of flexibility and information for post-processing.</p>
        <p>I even <a href="https://en.wikipedia.org/wiki/Raw_image_format" target="_blank" rel=”noreferrer”>shoot RAW</a> on my smartphone through third-party apps. Personally, I use ProShot App on my iPhone, but there are many other options.</p>
        ...
        <p>For software, I mostly use Adobe Lightroom Classic, occasionally in combination with Adobe Photoshop, but there are free software programs, such as Apple Photo (pre-installed on every Mac computer) and free open-source software <a href="https://www.gimp.org" target="_blank" rel=”noreferrer”>GIMP</a> (available on Linux, Windows and macOS).</p>
      ...
      <div class="mb-5"><h2 id="blog-color-grading-more-examples" class="anchor">More before-and-after examples</h2>
        ...
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_29" target="_blank" rel=”noreferrer”>
        ...
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_13" target="_blank" rel=”noreferrer”>
        ...
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_8" target="_blank" rel=”noreferrer”>
        ...
        <div class="row photo-block">
          <div class="col-md-6 mx-auto">
            <a href="<?php echo PATH; ?>/photography/?photo=photoid_72" target="_blank" rel=”noreferrer”>
      ...
      <hr/>
      <p class="footnote mb-3">Acknowledgements: Thanks to <a href="https://instagram.com/aaront.wn?igshid=1fj61pajls9ub" target="_blank" rel=”noreferrer”>Aaron Tang</a> for comments and edits.</p>
    </div><!--COL-->
  </div><!--ROW-->
</div><!--maincontent-->
