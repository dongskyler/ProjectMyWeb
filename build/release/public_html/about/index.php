...
<div class="container maincontent">
  <div class="row">
    ...
    <div>
        Here's my short bio:
            <ul>
                <li>I grew up in <a href="https://www.tripadvisor.com/Tourism-g297452-Dalian_Liaoning-Vacations.html?fid=8910bef2-878f-4d38-b12a-8db31df194ba" target="_blank">Dalian</a>, a city sitting on the coast line in the northern region of China. I love seafood.</li>
                <li>I graduated from <a href="https://www.beloit.edu" target="_blank">Beloit College</a> in Wisconsin with a Geology major and a Physics minor.</li>
                <li>Then, I went to <a href="https://www.jsg.utexas.edu" target="_blank">geoscience graduate school</a> at <a href="https://www.utexas.edu" target="_blank">the University of Texas at Austin</a> to study <a href="https://www.jsg.utexas.edu/news/2017/10/fueling-the-future/" target="_blank">methane hydrate</a>.</li>
                <li>Now I'm pursuing an alternative career path in software development.</li>
            </ul>
    </div>
    <div>Although I have a degree in science, I'm very versatile. I like making things and helping people. I like to use technology to improve the quality of our lives. 
            <ul>
                <li>I have built 2 websites in the past:
                    <ul><li><a href="https://sites.google.com/site/tiannongsdong/" target="_blank">My old personal website</a>, which have been online since I was an undergrad student.
                </li>
                ...
                <li>I have built many electronic devices. To name two of them:
                    <ul><li><a href="https://en.wikipedia.org/wiki/Coulombmeter" target="_blank">Coulombmeters</a> for <a href="https://en.wikipedia.org/wiki/Coulometry" target="_blank">coulometric titration (a chemistry technique)</a> using <a href="https://www.raspberrypi.org/help/what-%20is-a-raspberry-pi/" target="_blank">Raspberry Pi's</a> with <a href="https://chemistry.beloit.edu/classes/lisensky/" target="_blank">my chemistry professor George Lisensky</a>.</li>
                        <li>Homemade data acquisition system and <a href="https://en.wikipedia.org/wiki/Thermoelectric_cooling" target="_blank">Peltier plate</a> cooling system using an <a href="https://www.arduino.cc/en/guide/introduction" target="_blank">Arduino</a> for my graduate school research. The Arduino code was written in C.</li></ul></li></ul>
    </div>
    <div>
    ...
    <hr>
    <div class="col-12 mb-3">
      <div><h2 id="copyright-notice" class="anchor">Copyright notice for images</h2></div>
      <div>
